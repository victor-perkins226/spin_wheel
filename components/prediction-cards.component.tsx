  ...
  return (
    <div className="container mt-[40px] mb-[286px] flex flex-col gap-[40px]">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4">
        ...
        <div className="glass py-[15px] px-[24px] rounded-[40px] w-[210px] relative justify-self-end">
          <p className="flex items-center font-semibold text-[20px] gap-[7px]">
            4:02 <span className="text-[12px]">5m</span>
          </p>

          <div className="w-[64px] h-[64px] glass absolute rounded-full right-[24px] top-[-5] flex items-center justify-center backdrop-blur-2xl">
