...
export default function PredictionCard({
        ...
        <div className="max-w-[215px] flex flex-col gap-[33px] justify-between flex-1">
          ...
          <div className="flex flex-col gap-[22px] font-semibold text-[#FEFEFE]">
            <div className="flex justify-between">
              <p className="text-[20px]">${roundData?.closePrice?.toFixed(4) ?? 585.1229}</p>
              ...
              >
                ...
                <p className="text-[10px]">${priceDifference.toFixed(4) ?? 0.0}</p>
              </div>
            </div>
  ...
  const renderExpiredRoundContent = () => {
    ...
    const isUp = roundData?.closePrice && roundData?.lockPrice && roundData.closePrice > roundData.lockPrice
